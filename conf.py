...
BLOG_AUTHOR = "jcl"  # (translatable)
BLOG_TITLE = "18PDX - 18xx train gaming in the Pacific Northwest"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://18pdx.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://18pdx.com/"
BLOG_EMAIL = "plannedfailures@gmail.com"
BLOG_DESCRIPTION = "Summer's 18xx train gaming convention in beautful Portland, Oregon"  # (translatable)
...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -rapv --delete --delete-after output/ ./output/ jcl@kanga.nu:/var/www/18pdx/"
    ]
}
...
LICENSE = "licensed under Creative Commons License BY-NC-SA"

# A small copyright notice for the page footer (in HTML).
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date} - {license}'
